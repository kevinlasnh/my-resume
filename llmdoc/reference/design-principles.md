...
- **Primary Code**: `README.md:47-49` - Naming convention enforcement
...
| **ATS-Optimized** | Skills explicitly grouped by category with keywords | Tier 2 (content/basics/skills.md) |
